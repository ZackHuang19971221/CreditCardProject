...
public class VoidAuthViewModel extends BaseObservable {
    private final com.hotsauce.creditcard.io.voidauth.Input _voidInput = new Input();

    public VoidAuthViewModel(){
    ...
    public void SendVoidRequest(){
        ...
        Output output = creditCard.voidAuth(_voidInput);
        ...
        if (Objects.equals(output.ResultCode, ResultCode.Success))
        {
            ...
            transaction.TRANSACTION_STATUS = "VOID_AUTH";
